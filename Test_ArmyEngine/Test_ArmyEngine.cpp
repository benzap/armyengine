...
std::shared_ptr<entityType> createCursor() {
	...
	collisionComponent->setAttribute_float(ATTRIBUTE_RADIUS, 2.5);
...
std::shared_ptr<entityType> createButton(std::string name, int xPosition, int yPosition) {
	...
	entity->addComponent(shapeComponent);
	shapeComponent->setAttribute_string(ATTRIBUTE_SHAPE_TYPE, SHAPETYPE_RECTANGLE);
	shapeComponent->setAttribute_float(ATTRIBUTE_WIDTH, 120.0f);
	shapeComponent->setAttribute_float(ATTRIBUTE_HEIGHT, 50.0f);
	...
	textComponent->setAttribute_int(ATTRIBUTE_TEXT_SIZE, 10);
	...
	textComponent->setAttribute_float(ATTRIBUTE_OFFSET_X, 5);
	...
	positionComponent->setAttribute_float(ATTRIBUTE_POSITION_X, xPosition);
	positionComponent->setAttribute_float(ATTRIBUTE_POSITION_Y, yPosition);
	positionComponent->setAttribute_float(ATTRIBUTE_OFFSET_X, -50);
	...
	collisionComponent->setAttribute_float(ATTRIBUTE_WIDTH, 120.0);
	collisionComponent->setAttribute_float(ATTRIBUTE_HEIGHT, 50.0);
...
int main() {
	...
	armyEngine->addEntity(createButton("Resume", 100, 10));
